...
/* 
 * INSTANCE STRUCT (PUBLIC): 
 * Do ta dùng G_DECLARE_DERIVABLE_TYPE, ta phải định nghĩa struct này ở file .h.
 * Bất kỳ thuộc tính nào nằm ở đây đều có thể truy cập trực tiếp bằng cam->property.
 */
